...
export default function Author({ author }: IAuthor) {
  ...
  async function getAuthor() {
    const response = await apiClient.get(`/api/v1/author/${router.query.id}`)
  ...
  async function handleUpdate(event: FormEvent) {
    ...
    if (uploadFile) {
      ...
      await apiClient.patch(`/api/v1/author/upload/${router.query.id}`, data)
      setUploadFile(false)
    }
    ...
    await apiClient.patch(`/api/v1/author/${router.query.id}`, { name })
          ...
          <div className="col-sm-12 col-xl-8" style={{ padding: 30 }}>
            <div className="bg-secondary rounded h-100 p-4">
              ...
              <form onSubmit={handleUpdate}>
                ...
                <div className="mb-3">
                  <label htmlFor="avatar" class="form-label">
                    Avatar do Autor
                  </label>
