...
export const getServerSideProps = canSSRAuth(async ctx => {
  ...
  const responseAuthors = await apiClient.get('/api/v1/author')
  const responsePublishers = await apiClient.get('/api/v1/publisher')
  const responseBooks = await apiClient.get('/api/v1/book')
